...
##### re-written log under the federated learning #####
    ...
    # def print_network(self):
    #     """
    #     print network summary including module and number of parameters and flops
    #     """
    #     s, n, flops = self.get_network_description(self.model)
    #     if isinstance(self.model, nn.DataParallel):
    #         net_struc_str = '{} - {}'.format(self.model.__class__.__name__,
    #                                              self.model.module.__class__.__name__)
    #     else:
    ...
    #     print(line)
    #     net_lines.append(line)
    #     line = 'Network structure: [{}], with parameters: [{:,d}], FLOPs: [{}]'.format(net_struc_str, n, flops)      
    #     print(line)
    #     net_lines.append(line)
